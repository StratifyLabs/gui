...
static const lv_style_const_prop_t bg_light_const_list[] = {
  { .prop = LV_STYLE_BG_COLOR, .value = { .color = LV_COLOR_MAKE(0xaa,0xaa,0xaa)  } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t btn_light_const_list[] = {
  { .prop = LV_STYLE_BG_COLOR, .value = { .color = LV_COLOR_MAKE(0xaa,0xaa,0xaa)  } },
  { .prop = LV_STYLE_BORDER_COLOR, .value = { .color = LV_COLOR_MAKE(0xaa,0xaa,0xaa)  } },
...
static const lv_style_const_prop_t text_light_const_list[] = {
  { .prop = LV_STYLE_TEXT_COLOR, .value = { .color = LV_COLOR_MAKE(0xaa,0xaa,0xaa)  } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t toast_const_list[] = {
  ...
  { .prop = LV_STYLE_LINE_WIDTH, .value = { .num = 1 } },
  { .prop = LV_STYLE_HEIGHT, .value = { .num = LV_SIZE_CONTENT } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_PCT(33) } },
  { .prop = LV_STYLE_CLIP_CORNER, .value = { .num = 1 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
void lvgl_default_dark_apply_callback(lv_theme_t * theme, lv_obj_t * object){
...
const lvgl_api_style_descriptor_t * lvgl_default_dark_get_style_callback(int offset){
  const size_t size = sizeof(lvgl_default_dark_style_descriptor_list) / sizeof(lvgl_api_style_descriptor_t);
  if(offset < size){
    return &(lvgl_default_dark_style_descriptor_list[offset]);
  }
  return NULL;
}

lv_theme_t lvgl_default_dark_theme = {
  .apply_cb = lvgl_default_dark_apply_callback,
  .parent = NULL,
  .user_data = (void*)lvgl_default_dark_get_style_callback,
  .disp = NULL,
  .color_primary = 0,
  .color_secondary = 0,
...
lv_theme_t * lvgl_default_dark_theme_initialize(lv_disp_t * disp, lv_theme_t * parent){
  lvgl_default_dark_theme.disp = disp;
  lvgl_default_dark_theme.parent = parent;
  return &lvgl_default_dark_theme;
}
