...
static const lvgl_api_style_descriptor_t default_light_highdpi_style_descriptor_list[] = {
...
void default_light_highdpi_apply_callback(lv_theme_t * theme, lv_obj_t * object){
...
const lvgl_api_style_descriptor_t * default_light_highdpi_get_style_callback(int offset){
  const size_t size = sizeof(default_light_highdpi_style_descriptor_list) / sizeof(lvgl_api_style_descriptor_t);
  if(offset < size){
    return &(default_light_highdpi_style_descriptor_list[offset]);
  }
  return NULL;
}
