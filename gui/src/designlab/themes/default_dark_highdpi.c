...
lv_theme_t default_dark_highdpi_theme = {
...
lv_theme_t * default_dark_highdpi_theme_initialize(lv_disp_t * disp, lv_theme_t * parent){
  default_dark_highdpi_theme.disp = disp;
  default_dark_highdpi_theme.parent = parent;
  return &default_dark_highdpi_theme;
}
