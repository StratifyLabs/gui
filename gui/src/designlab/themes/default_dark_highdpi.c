...
extern const lv_font_t montserrat_sb_72;
extern const lv_font_t montserrat_sb_72;
extern const lv_font_t montserrat_sb_88;
extern const lv_font_t montserrat_sb_56;
extern const lv_font_t montserrat_sb_72;
extern const lv_font_t montserrat_sb_88;
extern const lv_font_t montserrat_sb_120;
extern const lv_font_t montserrat_sb_104;
extern const lv_font_t montserrat_sb_88;
extern const lv_font_t montserrat_sb_72;
...
static const lv_style_const_prop_t h1_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_sb_120 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 / 2 } },
...
static const lv_style_t h1_style = {
  ...
  .prop1 = 0xffff, .has_group = 0xff,

};

static const lv_style_const_prop_t h2_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_sb_104 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 / 2 } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_PCT(100) } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
...
static const lv_style_const_prop_t h3_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_sb_88 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 / 2 } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_PCT(100) } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
...
static const lv_style_const_prop_t h4_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_sb_72 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 / 2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 / 2 } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_PCT(100) } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t text_font_small_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_56 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t text_font_large_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_72 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t row_const_list[] = {
  ...
  { .prop = LV_STYLE_TEXT_COLOR, .value = { .color = LV_COLOR_MAKE(0xff,0xff,0xff)  } },
  { .prop = LV_STYLE_BG_OPA, .value = { .num = 255 } },
  { .prop = LV_STYLE_PAD_COLUMN, .value = { .num = 20 } },
...
static const lv_style_const_prop_t col_const_list[] = {
  ...
  { .prop = LV_STYLE_TEXT_COLOR, .value = { .color = LV_COLOR_MAKE(0xff,0xff,0xff)  } },
  { .prop = LV_STYLE_BG_OPA, .value = { .num = 255 } },
  { .prop = LV_STYLE_PAD_ROW, .value = { .num = 20 } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_SIZE_CONTENT } },
  { .prop = LV_STYLE_HEIGHT, .value = { .num = LV_SIZE_CONTENT } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t btn_outline_default_const_list[] = {
  ...
  { .prop = LV_STYLE_BORDER_WIDTH, .value = { .num = 8 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 *2 - 8 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 *2 - 8 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t paragraph_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_64 } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_PCT(100) } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t form_const_list[] = {
  { .prop = LV_STYLE_PAD_ROW, .value = { .num = 20 *2 } },
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 20 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 20 *4 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t form_field_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_72 } },
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 20 *2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 20 *2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 *2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 *2 } },
  { .prop = LV_STYLE_BORDER_WIDTH, .value = { .num = 8 /2 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t form_switch_const_list[] = {
  ...
  { .prop = LV_STYLE_WIDTH, .value = { .num = 256 } },
  { .prop = LV_STYLE_HEIGHT, .value = { .num = 128 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t form_hint_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_sb_56 } },
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 20 / 2 *2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 20 / 2 *2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 / 2 *2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 / 2 *2 } },
  { .prop = LV_STYLE_TEXT_COLOR, .value = { .color = LV_COLOR_MAKE(0x66,0x66,0x66)  } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t form_dropdown_list_const_list[] = {
  { .prop = LV_STYLE_TEXT_FONT, .value = { .ptr = (void*)&montserrat_r_72 } },
  { .prop = LV_STYLE_BORDER_WIDTH, .value = { .num = 8 /2 } },
  { .prop = LV_STYLE_MAX_HEIGHT, .value = { .num = 1000 } },
  { .prop = LV_STYLE_PAD_ROW, .value = { .num = 20 } },
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 20 *2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 20 *2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 *2 } },
...
static const lv_style_const_prop_t btn_lg_const_list[] = {
  ...
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 20 *2 *2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 20 *2 *2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 *2 *3/2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 *2 *3/2 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t badge_const_list[] = {
  ...
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 / 2 *2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 / 2 *2 } },
  { .prop = LV_STYLE_RADIUS, .value = { .num = 16 } },
  { .prop = LV_STYLE_HEIGHT, .value = { .num = LV_SIZE_CONTENT } },
  { .prop = LV_STYLE_WIDTH, .value = { .num = LV_SIZE_CONTENT } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t badge_sm_const_list[] = {
  ...
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 20 *2 /2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 20 *2 /2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 / 2 *2 /2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 / 2 *2 /2 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t badge_lg_const_list[] = {
  ...
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 20 *2 *2 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 20 *2 *2 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 / 2 *2 *3/2 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 / 2 *2 *3/2 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t screen_const_list[] = {
  ...
  { .prop = LV_STYLE_TEXT_COLOR, .value = { .color = LV_COLOR_MAKE(0xff,0xff,0xff)  } },
  { .prop = LV_STYLE_PAD_ROW, .value = { .num = 20 / 2 } },
  { .prop = LV_STYLE_PAD_COLUMN, .value = { .num = 20 / 2 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t scrollbar_const_list[] = {
  ...
  { .prop = LV_STYLE_WIDTH, .value = { .num = 24 } },
  { .prop = LV_STYLE_HEIGHT, .value = { .num = 24 } },
...
static const lv_style_const_prop_t modal_content_enabled_const_list[] = {
  ...
  { .prop = LV_STYLE_TRANSLATE_Y, .value = { .num = 100 } },
  { .prop = LV_STYLE_TRANSITION, .value = { .ptr = (void*)&transition_delayed_slow } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t card_const_list[] = {
  { .prop = LV_STYLE_RADIUS, .value = { .num = 16 *2 } },
  { .prop = LV_STYLE_BG_OPA, .value = { .num = 255 } },
  { .prop = LV_STYLE_BG_COLOR, .value = { .color = LV_COLOR_MAKE(0x22,0x22,0x22)  } },
...
static const lv_style_const_prop_t toast_top_right_const_list[] = {
  ...
  { .prop = LV_STYLE_X, .value = { .num = 80 * -1 } },
  { .prop = LV_STYLE_Y, .value = { .num = 80 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t toast_bottom_right_const_list[] = {
  ...
  { .prop = LV_STYLE_X, .value = { .num = 80 *-1 } },
  { .prop = LV_STYLE_Y, .value = { .num = 80 *-1 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t padding_tiny_const_list[] = {
  { .prop = LV_STYLE_PAD_LEFT, .value = { .num = 20 / 3 } },
  { .prop = LV_STYLE_PAD_RIGHT, .value = { .num = 20 / 3 } },
  { .prop = LV_STYLE_PAD_TOP, .value = { .num = 20 / 3 } },
  { .prop = LV_STYLE_PAD_BOTTOM, .value = { .num = 20 / 3 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t outline_border_secondary_const_list[] = {
  ...
  { .prop = LV_STYLE_OUTLINE_WIDTH, .value = { .num = 8 } },
  { .prop = LV_STYLE_OUTLINE_PAD, .value = { .num = 8 } },
...
static const lv_style_const_prop_t progress_bar_background_const_list[] = {
  { .prop = LV_STYLE_HEIGHT, .value = { .num = 40 } },
  { .prop = LV_STYLE_BG_OPA, .value = { .num = 255 } },
  { .prop = LV_STYLE_BG_COLOR, .value = { .color = LV_COLOR_MAKE(0x66,0x66,0x66)  } },
  { .prop = LV_STYLE_RADIUS, .value = { .num = 16 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
...
static const lv_style_const_prop_t grow_const_list[] = {
  { .prop = LV_STYLE_TRANSFORM_WIDTH, .value = { .num = 8 } },
  { .prop = LV_STYLE_TRANSFORM_HEIGHT, .value = { .num = 8 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lv_style_const_prop_t arc_indicator_const_list[] = {
  ...
  { .prop = LV_STYLE_ARC_WIDTH, .value = { .num = 30 } },
...
static const lv_style_const_prop_t line_const_list[] = {
  { .prop = LV_STYLE_LINE_WIDTH, .value = { .num = 2 } },
...
static const lv_style_const_prop_t colorwheel_main_const_list[] = {
  { .prop = LV_STYLE_ARC_WIDTH, .value = { .num = 40 } },
  { .prop = LV_STYLE_PROP_INV, .value = { .num = 0 } }
};
...
static const lvgl_api_style_descriptor_t default_dark_highdpi_style_descriptor_list[] = {
...
void default_dark_highdpi_apply_callback(lv_theme_t * theme, lv_obj_t * object){
...
const lvgl_api_style_descriptor_t * default_dark_highdpi_get_style_callback(int offset){
  const size_t size = sizeof(default_dark_highdpi_style_descriptor_list) / sizeof(lvgl_api_style_descriptor_t);
  if(offset < size){
    return &(default_dark_highdpi_style_descriptor_list[offset]);
  }
  return NULL;
}

lv_theme_t themes_default_dark_highdpi = {
  .apply_cb = default_dark_highdpi_apply_callback,
  .parent = NULL,
  .user_data = (void*)default_dark_highdpi_get_style_callback,
  .disp = NULL,
  .color_primary = 0,
  .color_secondary = 0,
  .font_small = &montserrat_r_56,
  .font_normal = &montserrat_r_64,
  .font_large = &montserrat_r_72,
  .flags = 0
};

lv_theme_t * themes_default_dark_highdpi_initialize(lv_disp_t * disp, lv_theme_t * parent){
  themes_default_dark_highdpi.disp = disp;
  themes_default_dark_highdpi.parent = parent;
  return &themes_default_dark_highdpi;
}
